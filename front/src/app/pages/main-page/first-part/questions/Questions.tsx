...
import BudgetSlider from "@/app/pages/main-page/first-part/questions/BudjetSlider";
...
const Questions: React.FC = () => {
    ...
    const handleSubmit = () => {
        // Добавляем значения из инпутов name, email и phone в конец массива selectedAnswers
        const updatedAnswers = [...selectedAnswers, name, phone];

        console.log('TUT - ', updatedAnswers);
        ...
        fetch('/api/submit-answers', {
            ...
            body: JSON.stringify(updatedAnswers),  // Отправляем массив с ответами и контактной информацией
        })
            ...
            <>
                ...
                <div className={currentQuestion.question === "#7 Залиште свої контакти і ми зв’яжемося з вами протягом 2 робочих днів" ?
                    ...
                    {currentQuestion.question === "#7 Залиште свої контакти і ми зв’яжемося з вами протягом 2 робочих днів" || currentQuestion.question === "#9 Залиште свої контакти і ми зв’яжемося з вами протягом 2 робочих днів" ? (
                        ...
                        <BudgetSlider min={currentQuestion.min} max={currentQuestion.max} step={10}
    ...
    return (
        <div className={styles.questions} ref={quizSectionRef} id="quiz">
            ...
            <div className={styles.wrapper}>
                ...
                {step === 0 ? (
                    <>
                        <p className={styles.headTxt}>дізнайся, скільки коштує твій індивідуальний запит!</p>
